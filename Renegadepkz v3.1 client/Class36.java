...
public class Class36
{
 ...
 public static int offset = 33600;
    public static void methodCustomAnimations1(boolean flag, int file)
    {
	byte abyte0[];
	abyte0 = FileOperations.ReadFile("./anim/"+file+".dat");
  ...
  public static void methodCustomAnimations(boolean flag, int file)
	...
	Class20.FrameStart[file] = offset;
	System.out.println("OldFile: "+file+" loaded!");
	Class20.FrameStart[file] = offset;
	...
	public int anInt638;
        public static int FrameStart[] = new int[5000];
