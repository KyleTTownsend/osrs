	...
	public void buryItem(int item, int slot, int ID) {
		...
		if (c.playerHasItem(item)) {
			...
			case 1961:
				...
				c.sendQuest("" + c.currentHealth + "", 4016);
				break;
			case 3642: // Extreme ranging(4)
				if (System.currentTimeMillis() -c.potionDelay < 1700)
				return;
				c.foodDelay = System.currentTimeMillis();
			...
			c.setAnimation(829);
			c.playerLevel[2] = c.getLevelForXP(c.playerXP[4]);
			c.playerLevel[2] += c.abc2;
			c.sendFrame126(""+c.playerLevel[4]+"", 4006);
			c.deleteItem(3642, slot, 1);
			c.addItem(10000, 1);
			c.updateRequired = true;
			c.appearanceUpdateRequired = true;
			c.sendQuest("" + c.playerLevel[4] + "", 4006);
			c.strPotTimer = 60;
                                if(c.currentHealth <= 0) {
                                break;
                                }
                                c.sM("You drink some of your extreme ranging potion.");
...
c.magePotTimer = 60;
				if (c.playerLevel[6] > c.playerLevel[c.playerMagic])
					c.playerLevel[6] = c.playerLevel[6] += 36;
				c.sendQuest("" + c.playerLevel[6] + "", 100000);
				if (c.playerLevel[0] > c.playerLevel[c.playerMagic])
					c.playerLevel[0] = c.playerLevel[6] += 36;
				c.sendQuest("" + c.playerLevel[6] + "", 100000);
				if (c.playerLevel[1] > c.playerLevel[c.playerMagic])
					c.playerLevel[1] = c.playerLevel[6] += 36;
				c.sendQuest("" + c.playerLevel[6] + "", 100000);
break;
			case 3042:
				if (System.currentTimeMillis() -c.potionDelay < 2000)
...
if(c.playerLevel[0] >= 10 && c.playerLevel[1] >= 10 && c.playerLevel[2] >= 10 && c.playerLevel[3] >= 10 && c.playerLevel[4] >= 10 && c.playerLevel[5] >= 10){
c.setAnimation(0x33D);
...
c.sM("You Are to weak to do this.");
...
c.addItem(139, 1);
c.prayerRestore();
c.sendQuest("" + c.playerLevel[5] + "", 5012);
break;
			case 139:
				if (System.currentTimeMillis() -c.potionDelay < 2000)
				return;
...
c.sendQuest("" + c.playerLevel[5] + "", 4012);
break;
case 2444: // Extreme_ranging_potion(4)
if (System.currentTimeMillis() -c.potionDelay < 2000)
return;
c.foodDelay = System.currentTimeMillis();
c.potionDelay = System.currentTimeMillis();
...
c.rangePotTimer = 60;
				...
				c.sM("You have 3 doses of potion left."); 
break;
case 169: // Extreme_ranging_potion(4)
if (System.currentTimeMillis() -c.potionDelay < 2000)
return;
c.foodDelay = System.currentTimeMillis();
c.potionDelay = System.currentTimeMillis();
...
c.rangePotTimer = 60;
				...
				c.sM("You have 2 doses of potion left."); 
break;
case 171: // Extreme_ranging_potion(4)
if (System.currentTimeMillis() -c.potionDelay < 2000)
return;
c.foodDelay = System.currentTimeMillis();
c.potionDelay = System.currentTimeMillis();
...
c.rangePotTimer = 60;
				...
				c.sM("You have 1 dose of potion left."); 
break;
case 173: // Extreme_ranging_potion(4)
if (System.currentTimeMillis() -c.potionDelay < 2000)
return;
c.foodDelay = System.currentTimeMillis();
c.potionDelay = System.currentTimeMillis();
...
c.sendQuest("" + c.playerLevel[2] + "", 4006);
c.strPotTimer = 60;
				c.sM("You drink some of your Extreme strength potion.");
				c.sM("You have 3 doses of potion left."); 
break;
case 157: // Extreme strength (3)
if (System.currentTimeMillis() -c.potionDelay < 2000)
return;
c.foodDelay = System.currentTimeMillis();
c.potionDelay = System.currentTimeMillis();
...
c.appearanceUpdateRequired = true;
c.defPotTimer = 60;
				c.sM("You drink some of your Extreme defence potion.");
				c.sM("You have 3 doses of potion left.");
c.refreshSkills();
break;

case 163: // Extreme defence (3)
if (System.currentTimeMillis() -c.potionDelay < 2000)
return;
c.foodDelay = System.currentTimeMillis();
c.potionDelay = System.currentTimeMillis();
...
c.appearanceUpdateRequired = true;
c.defPotTimer = 60;
				c.sM("You drink some of your Extreme defence potion.");												c.sM("You have 1 dose of potion left.");
c.refreshSkills();
break;


case 167: // Extreme defence (1)
if (System.currentTimeMillis() -c.potionDelay < 2000)
return;
c.foodDelay = System.currentTimeMillis();
c.potionDelay = System.currentTimeMillis();
...
c.appearanceUpdateRequired = true;
c.attPotTimer = 60;
				c.sM("You drink some of your extreme attack potion.");
				c.sM("You have 3 doses of potion left.");
break;

case 145: // Extreme atk (3)
if (System.currentTimeMillis() -c.potionDelay < 2000)
return;
c.foodDelay = System.currentTimeMillis();
c.potionDelay = System.currentTimeMillis();
