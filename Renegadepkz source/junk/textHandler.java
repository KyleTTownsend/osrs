...
c.sendQuest("WoeshieScape", 640);
c.sendQuest("Quests", 663);
c.sendQuest("Server uptime", 183);
c.sendQuest("@or1@Add Friend", 5070);
c.sendQuest("@or1@Del Friend", 5071);
c.sendQuest("@or1@Add Name", 5720);
c.sendQuest("@or1@Del Name", 5721);
...
c.sendFrame126("The Bank of WoeshieScape - Deposit Box", 7421);
c.sendQuest("The Bank of 2 Speced - Bank Pin", 14923);
c.sendQuest("", 15107);
c.sendQuest("Set Pin", 15078);
c.sendQuest("Delete Pin", 15082);
c.sendQuest("", 15107);
c.sendQuest("Set Pin", 15078);
c.sendQuest("The Bank of WoeshieScape",5383);
c.sendQuest("",4439);
...
c.sendQuest("      WoeshieScape", 15950);//Title
