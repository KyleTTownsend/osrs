...
public class Wearing {
		...
		if (ItemName2.startsWith("claws")
		 ...
		 || ItemName2.startsWith("halberd")) {
			...
			return 10;
				...
				return 99;
			} else if (ItemName.startsWith("elysian spirit shield")) {
				return 75;
			} else if (ItemName.startsWith("divine spirit shield")) {
				return 75;
			} else if (ItemName.startsWith("arcane spirit shield")) {
				return 75;
			} else if (ItemName.startsWith("spectral spirit shield")) {
				return 99;
	...
	public int GetCLPrayer(int ItemID) {
		...
		if (ItemName.startsWith("divine spirit shield")) {
			return 75;
		}
		if (ItemName.startsWith("elysian spirit shield")) {
			return 75;
		}
		if (ItemName.startsWith("spectral spirit shield")) {
			return 75;
		}
		if (ItemName.startsWith("arcane spirit shield")) {
			return 75;
		}
		return 1;
	}
	public int GetCLFarming(int ItemID) {
		...
		if (ItemName.startsWith("Chaotic maul")) {
			return 80;
		}
		return 1;
	}
